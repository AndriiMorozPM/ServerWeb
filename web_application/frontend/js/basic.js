...
function modal_update_patients (added_new, id) {
   ...
   if (added_new) { add_patient(master, name, age, doctor, hospital);      }
   else           { edit_patient(id, master, name, age, doctor, hospital); }
...
function clear_input() {
   ...
   switch (target) {
      ...
      case "doctors":   $("#doctor_name").val("");
                        ...
                        break;
      case "patients":  $("#patient_master").val("");
                        $("#patient_name").val("");
                        $("#patient_age").val("");
                        $("#patient_doctor").text("Виберіть лікаря");
